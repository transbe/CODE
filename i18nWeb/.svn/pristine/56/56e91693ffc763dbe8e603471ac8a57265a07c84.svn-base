            ...
            if (success == 1) {
                ...
                switch (code) {
                    ...
                    case "PU03010":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03010")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03013":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03013")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03032":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03032")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU01000":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU01000")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU01020":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU01020")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03030":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03030")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03033":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03033")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03035":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03035")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03000":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03000")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03038":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03038")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03036":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03036")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU03031":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU03031")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (success == 1) {
                ...
                //当前用户不存在默认企业Id
                $('.hidkuai2 span').text(getLanguageValue("tip.check.noDefultEnp"));
            }
        },
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            // console.log(XMLHttpRequest);
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.success == 1) {
                ...
                layer.alert(getLanguageValue("tip.set.failEnp"), {
                    title: getLanguageValue("tip"),
                    skin: 'self-alert'
                });
            ...
            if (success == 1) {
                ...
                switch (data.code) {
                    case "400":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("400")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "403":
                        // $('.hidkuai2 span').text(getLanguageValue("403"));
                        showMsg(getLanguageValue(getLanguageValue("403")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
                    ...
                    case "PU01023":
                        ...
                        showMsg(getLanguageValue(getLanguageValue("PU01023")));
                        //诸葛IO
                        try {
                            if (zhugeSwitch == 1) {
                                zhuge.track('登录失败', {
