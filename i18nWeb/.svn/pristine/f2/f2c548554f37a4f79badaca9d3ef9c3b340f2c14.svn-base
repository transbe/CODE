...
function initGraph() {
    ...
    option3 = {
        ...
        yAxis: [{
            ...
            data: ["",getLanguageValue("field.zhanchang")+"/"+getLanguageValue("field.fashi"), getLanguageValue("field.jueyuanzhuangzhi"),getLanguageValue("field.hengdianweiyi"),
            getLanguageValue("field.pailiu"),getLanguageValue("field.taoguan"),getLanguageValue("field.jiaochapingxing"), getLanguageValue("field.dingxiangzuan"), getLanguageValue("field.jiakong")]
        },{
              type: "value",
              min: 0,
              max: 8,
        ...
        series: [
           {
            ...
            },
            {
                ...
                data:"",
                // data:  [{ "value":"1", name:"平行1"},{"value":"1", name:"平行2" },{ "value":"1",name:"平行3"}],
                yAxisIndex:1,
                type: 'scatter',
...
function drawEquipmentGraph(result) {
    if (option3 && typeof option3 === "object") {
        ...
        option3.series[0].data = result.station; // 战场
        option3.series[1].data = result.valve; // 阀室

        option3.series[2].data = result.protection;  // 有保护装置绝缘接头
        option3.series[3].data = result.spd;  // 无保护装置绝缘接头
        option3.series[4].data = result.fikwithspd;  // 有保护装置绝缘法兰
        option3.series[5].data = result.fikwithoutspd; // 无保护装置绝缘法兰

        option3.series[6].data = result.rectifier; //恒电位移
        option3.series[7].data = result.drainageAnode; //排流
        option3.series[8].data = result.drivePipe; // 套管
        option3.series[9].data = result.crossParallelArea; //  交叉平行
        option3.series[10].data = result.directionalDrilling; // 定向钻
        option3.series[11].data = result.abovegroundpl; // 架空
