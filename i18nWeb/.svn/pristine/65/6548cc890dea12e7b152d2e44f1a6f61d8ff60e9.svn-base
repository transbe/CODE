...
function initEcharts() {
    ...
    option = {
        ...
        legend: {
            top: "10%",
            left: "center",
            data: [getLanguageValue("couponOnPotentailAvg"), getLanguageValue("couponOFFPotentailAvg"), getLanguageValue("SoilResistivityAvg")]
        },
        xAxis: [{
            nameLocation: "middle",
            nameGap: "40",
        ...
        yAxis: [{
            name: getLanguageValue("couponAvg")+"（mV）",
            nameLocation: "middle",
            nameGap: "50",
            type: 'value',
            axisLabel: {
        ...
        {
            name: getLanguageValue("SoilResistivityAvg")+"(Ω•m)",
            nameLocation: "middle",
            nameGap: "50",
            type: 'value',
            axisLabel: {
