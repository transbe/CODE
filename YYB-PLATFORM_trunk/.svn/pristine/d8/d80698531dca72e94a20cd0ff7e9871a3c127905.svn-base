...
(function($) {
    ...
    // console.log(bvConstructor);
    // console.log($.fn.bootstrapValidator.Constructor.prototype.validateField);
    bvConstructor.prototype.validateField = function(field) {
        ...
        // console.log(fields.field.validators.notEmpty);
        // console.log(field);
        // console.log(fields);
        var name = field;
        // console.log(this.options.fields[name].validators.notEmpty);
        var testNotEmpty = this.options.fields[name].validators.notEmpty;
        // console.log(testNotEmpty);
        var inputType = $(fields).prop("type");
        // console.log(inputType);
        // console.log($(fields).val());

        // console.log(testNotEmpty == undefined);
        // console.log(inputType == "text");
        // console.log(valTest == "" || valTest == null || valTest == undefined)
...
(function($) {
    $.fn.bootstrapValidator.i18n.fileName = $.extend($.fn.bootstrapValidator.i18n.fileName || {}, {
        'default': 'Please upload pdf file', // 默认
    });

    $.fn.bootstrapValidator.validators.fileName = {
        /*
         *  上传文件的判断
         * @param {BootstrapValidator} validator Validate plugin instance
         * @param {jQuery} $field Field element
