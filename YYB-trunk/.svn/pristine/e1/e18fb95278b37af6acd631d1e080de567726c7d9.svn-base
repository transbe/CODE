            ...
            if (res.success == 1) {
                ...
                if (detectdata.length > 0) {
                    ...
                    for (var i = 0; i < detectdata.length; i++) {
                        ...
                        data_y_onPotentialOfAvg.push(detectdata[i].onPotentialOfAvg); //平均通电电位
                    ...
                    option2.series[1].data = onPotentialOfMax;
                    option2.series[2].data = data_y_onPotentialOfAvg;
                    option2.series[3].data = data_y_onPotentialOfMin;

                    option2.series[4].data = data_y_offPotentialOfCouponMax;
                    option2.series[5].data = data_y_offPotentialOfCouponAvg;
...
function initEcharts() {
    ...
    option2 = {
        ...
        legend: {
            top: "10%",
            orient: 'horizontal',
            // data: [getLanguageValue("soilResistivity"), getLanguageValue("couponOnPotentialAvg"), getLanguageValue("couponOFFPotentialAvg")]
            data: [getLanguageValue("soilResistivity"), getLanguageValue("ONPotentialMax"),getLanguageValue("ONPotentialAvg"),getLanguageValue("ONPotentialMin"),getLanguageValue("couponOFFPotentialMax"), getLanguageValue("couponOFFPotentialAvg"), getLanguageValue("couponOFFPotentialMin")]
        },
        xAxis: [{
            nameLocation: "middle",
            nameGap: "40",
