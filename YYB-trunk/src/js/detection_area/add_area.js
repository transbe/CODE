...
function resetForm() {
    ...
    var result = hasChangeData();
    if (result == true) {
        layer.confirm(getLanguageValue("tip.save.ask"), {
...
function saveArea(modifyFlag) {
    ...
    $.ajax({
        ...
        success: function (successResult) {
            if (successResult.success == 1) {
                parent.layer.msg(getLanguageValue("tip.submit.success"), {
                ...
                parent.layer.alert(getLanguageValue("tip.save.fail"), {
                    title: getLanguageValue("tip"),
                    skin: "self-alert"
                });
                result = false;
...
function saveChangeData() {
    ...
    $.ajax({
        ...
        success: function (successResult) {
            if (successResult.success == 1) {
                layer.msg(getLanguageValue("tip.save.success"), {
                    time: MSG_DISPLAY_TIME,
                    skin: "self-msg"
                });
                changeDataArr = [];
                ...
                layer.alert(getLanguageValue("tip.save.fail"), {
                    title: getLanguageValue("tip"),
                    skin: "self-alert"
                });
                changeDataArr = [];
