      ...
      this.init = function () {
         var pickListHtml =
                ...
                //  "</div>";
                 ...
                 " </div>" +
                 " <div class='col-sm-1 pickListButtons pickListLenght' style='text-align: center;padding-top: 50px;'>" +
                 ...
                 " </div>" +
                 " <div class='form-group col-sm-6 pick-right-style'  style = 'margin-top:0'>" +
