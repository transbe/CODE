...
function getMenuNodes() {
    ...
    var menuArr1 = [{
        ...
        // {
        //     id: 0,
        //     text: getLanguageValue('potentiostat'),
        //     url: 'src/html/cps_system/potentiostat/potentiostat.html',
        //     icon: 'fa fa-sitemap'
        // },
         {
            id: 3,
        ...
        },
        {
            ...
            childs: [{
                ...
                {
                    id: 93,
                    text: getLanguageValue('evaluation_pit'),
                    url: 'src/html/toolkit/evaluation_pit.html',
                }
            ]
        }
    ];
