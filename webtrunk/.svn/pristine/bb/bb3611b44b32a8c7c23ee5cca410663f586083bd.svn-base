                    ...
                    if (language == "en") {
                        switch (data.reason) {
                            case "注册企业不存在":
                                ...
                                showMsg(getLanguageValue("rejectEnterprise") + en_reason + " " + getLanguageValue("or") + "<a class='blue' href='./create_enterprise.html'> " + getLanguageValue("CreateEnp") + " </a>");
                                break;
                            ...
                            case "电话无人接听":
                                ...
                                break;
                            default:
                                showMsg("Registered businesses were dismissed." + " " + getLanguageValue("or") + "<a class='blue' href='./create_enterprise.html'> " + getLanguageValue("CreateEnp") + " </a>");
                                break;
                        }
                        return en_reason;
                    } else {
                        showMsg(getLanguageValue("rejectEnterprise") + " " + getLanguageValue("or") + " <a class='blue' href='./create_enterprise.html'> " + getLanguageValue("CreateEnp") + " </a>"); // 驳回原因
                    }
                }
            } else {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (success == 1) {
                ...
                try {
                    if (tjSwitch == 1) {
                        tjIdentify(JSON.parse(lsObj.getLocalStorage('userBo')));
                    }
                } catch (e) {}
                getUserInfo();
