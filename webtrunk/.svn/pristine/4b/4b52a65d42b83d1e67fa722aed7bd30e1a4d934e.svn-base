...
function loadTable() {
    $("#reportTable").bootstrapTable({
        url: '/cloudlink-core-file/attachment/getFileInfoListByBizIdAndBizAttr?businessId=' + applyId + '&bizType=doc'+ "&token="+ lsObj.getLocalStorage("token"),
        toolbar: "#toolbar",
...
function exportSingle(objectId) {
    var url = "/cloudlink-core-file/attachment/downLoadOneFile?fileId=" + objectId+ "&token="+ lsObj.getLocalStorage("token");
