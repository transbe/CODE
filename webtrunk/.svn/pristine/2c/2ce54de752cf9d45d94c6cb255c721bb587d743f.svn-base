 ...
 window.zhuge.load = function(b, x) {
     if (!document.getElementById("zhuge-js")) {
         ...
         a.onerror = function() {
             window.zhuge.identify = window.tjSdk.track = function(ename, props, callback) {
 ...
 //window.zhuge.load('a9aac4178db640aea1d22b00192e2905');//阴保专家正式KEY 与app使用同一个Key
 window.zhuge.load('433a73b7c0f54209878d15b6f2d07cce', { debug: true }); //阴保管家测试Key
