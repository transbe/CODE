    ...
    Option1 = {
        ...
        columns: [
            ...
            [{
                ...
                title: getLanguageValue("Max")+'(mV)',
                sortable: true,
                width: '8%'
            }, {
                field: 'onPotentialOfMin',
                title: getLanguageValue("Min")+'(mV)',
                sortable: true,
                width: '8%'
            }, {
                field: 'onPotentialOfAvg',
                title: getLanguageValue("Avg")+'(mV)',
                sortable: true,
                width: '8%'
            }, {
                field: 'avOfPlMax',
                title:  getLanguageValue("Max")+'(V)',
                sortable: true,
                width: '8%'
            }, {
                field: 'avOfPlMin',
                title:  getLanguageValue("Min")+'(V)',
                sortable: true,
                width: '8%'
            }, {
                field: 'avOfPlAvg',
                 title:  getLanguageValue("Avg")+'(V)',
                sortable: true,
                width: '8%'
            }]
        ],
        ...
        columns: [
            [{
               ...
               title: getLanguageValue("OFFPotentialOFCoupon"),
                ...
                title: getLanguageValue("soilResistivity")+'(Ω.m)',
                sortable: true,
                width: '7%',
                rowspan: 2
            }, {
            ...
            [{
                ...
                title: getLanguageValue("Avg")+'(A/m²)',
                sortable: true,
                width: '7%'
            }, {
        ...
        columns: [
            [{
               ...
               title: getLanguageValue("OFFPotentialOFCoupon"),
                ...
                title: getLanguageValue("CPCurremtDensity"),
                rowspan: 1,
                colspan: 1
            }, {
                field: 'soilResistivity',
    ...
    $('#tb-all-task').bootstrapTable({
        ...
        columns: [
            [{
                ...
                title: getLanguageValue("onPoteniallOfCasing")+'(mV)',
                sortable: true,
                width: '9%',
                rowspan: 2
            }, {
                field: 'offPotenialOfCasing',
                title: getLanguageValue("offPotenialOfCasing")+'(mV)',
                sortable: true,
                width: '9%',
                rowspan: 2
            },
    ...
    $('#tb-all-task').bootstrapTable({
        ...
        columns: [
            [{
                ...
                field: 'offPotentialOfAvg',
                title: getLanguageValue("offPotentialOfAvg")+'(mV)',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
            ...
            [{
                ...
                title: getLanguageValue("selfPiple")+'(mV)',
                sortable: true,
                width: '6%'
            }, {
                field: 'forPlPotentialRecitifierOn',
                 title: getLanguageValue("outsidePiple")+'(mV)',
                sortable: true,
                width: '6%'
            }, {
    ...
    $('#tb-all-task').bootstrapTable({
        ...
        columns: [
            ...
            [{
                ...
                title: getLanguageValue("Max")+'(A/m²)',
                sortable: true,
                width: '4%'
            }, {
                field: 'plToCouponAcMin',
                title: getLanguageValue("Min")+'(A/m²)',
                sortable: true,
                width: '4%'
            }, {
...
function M8() {
    ...
    $('#tb-all-task').bootstrapTable({
        ...
        columns: [{
            ...
            field: 'onPotentialOfAvg',
            title: getLanguageValue("onPotentialOfAvg")+'（V）',
            sortable: true,
            width: '9%'
        }, {
            field: 'avOfPlAvg',
            title: getLanguageValue("avOfPlAvg")+'（V）',
            sortable: true,
            width: '9%'
        }, {
            field: 'couponOfPlNonProtectSide',
            title:  getLanguageValue("couponOfPlNonProtectSide")+'（V）',
            sortable: true,
            width: '9%'
        }, {
            field: 'avOfPlNonProtectSide',
            title: getLanguageValue("avOfPlNonProtectSide")+'（V）',
            sortable: true,
            width: '9%'
        }, {
            field: 'crossoverCurrent',
            title: getLanguageValue("crossoverCurrent")+'（A）',
            sortable: true,
            width: '9%'
        }, {
            field: analysisResult,
    ...
    $('#tb-all-task').bootstrapTable({
        ...
        columns: [
            [{
                ...
                title: getLanguageValue("cpLoopResistance")+'（Ω）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'setupPotentialOfRecitifier',
                title: getLanguageValue("setupPotentialOfRecitifier")+'（mV）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'setupOffPotentialOfRecitifier',
                title:  getLanguageValue("setupOffPotentialOfRecitifier")+'（mV）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'onPotentialOnPipeConnectionAvg',
                title: getLanguageValue("onPotentialOnPipeConnectionAvg")+'（mV）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'offPotentialOnPipeConnectionAvg',
                title: getLanguageValue("offPotentialOnPipeConnectionAvg")+'（mV）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'onPotentialOnAnodeAvg',
                title: getLanguageValue("onPotentialOnAnodeAvg")+'（mV）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'offPotentialOnAnodeAvg',
                title:  getLanguageValue("offPotentialOnAnodeAvg")+'（mV）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'apparentResistanceOfPl',
                title: getLanguageValue("apparentResistanceOfPl")+'（Ω）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
                field: 'apparentResistanceOfGroundbed',
                title: getLanguageValue("apparentResistanceOfGroundbed")+'（Ω）',
                sortable: true,
                width: '6%',
                rowspan: 2
            }, {
    ...
    $('#tb-all-task').bootstrapTable({
        ...
        columns: [
            ...
            [{
                ...
                title: getLanguageValue("potential")+'（mV）',
                sortable: true,
                width: '7%'
            }, {
                field: 'plOffPotentialAnodeDisconnected',
                title: getLanguageValue("offPotential")+'（mV）',
                sortable: true,
                width: '7%'
            }, {
                field: 'potentialOfAnodeDisconnected',
                title: getLanguageValue("potentialOfAnodeDisconnected")+'（mV）',
                sortable: true,
                width: '7%'
            }, {
                field: 'currentFromPlToAnode',
                title: getLanguageValue("outputCurrent")+'（mA）',
                sortable: true,
                width: '7%'
            }, {
                field: 'anodeGroundResistance',
                title: getLanguageValue("anodeGroundResistance")+'（Ω）',
                sortable: true,
                width: '5%'
            }]
        ],
    ...
    $('#tb-all-task').bootstrapTable({
        ...
        columns: [
            [{
                ...
                field: 'avOfPlAvg',
                title: getLanguageValue("OFFPotentialOFCoupon")+'（mV）',
                rowspan: 2
            }, {
                field: 'selfCorrisionPotential',
                title: getLanguageValue("selfCorrisionPotential")+'（mV）',
                rowspan: 2
            },{
                title: getLanguageValue("voltage")
            },{
            ...
            [{
                ...
                field: 'currentFromPlToAnode',
                title:  getLanguageValue("currentFromPlToAnode")+'（mA）',
                sortable: true,
                width: '5%'
            }, {
                field: 'sumCurrentFromPlToAnode',
                title:  getLanguageValue("sumCurrentFromPlToAnode")+'（mA）',
                sortable: true,
                width: '5%'
            }, {
                field: 'anodeGroundResistance',
