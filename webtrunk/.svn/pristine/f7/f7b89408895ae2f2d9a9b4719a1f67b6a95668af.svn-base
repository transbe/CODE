  ...
  function loadIndex() {
      $(document).ready(function () {
          ...
          if (roleNameNum == 2) {
              //   alert("检测人");
              $("#firstPage").attr("data-id", "src/html/index/welcom_collect.html").attr("data-searchId", "1");
              ...
              $("#firstPage").attr("data-id", "src/html/expert_index/home.html").attr("data-searchId", "1");
              ...
              //   alert("非检测人");
              $("#firstPage").attr("data-id", "src/html/index/welcome.html").attr("data-searchId", "1");
  ...
  function getUserProfilePath() {
      ...
      if (profilePhotoId == null || profilePhotoId == "") {
          ...
          profilePhotoPath = "/cloudlink-core-file/file/getImageBySize?fileId=" + profilePhotoId + "&viewModel=fill&width=30&hight=30"+ "&token="+ lsObj.getLocalStorage("token");
      }
