  ...
  function getMarkData(data) {
      ...
      if (data.totalOfMark) {
        ...
        //   var totalOfMarkY = ['汇流桩', '定向钻桩', '排流桩', '绝缘接头桩', '交叉平行', '套管桩'];
          var totalOfMarkY = [
            //   getLanguageValue("isHighConsequenceArea"),
            //   getLanguageValue("Parallel-Crossing"),
            //   getLanguageValue("isSubwayParallel"),
            //   getLanguageValue("isHighVoltageCorridor"),
        ...
        //   totalOfMarkArr.push(totalOfMark.highconsequencearea); //高后果区
        //   totalOfMarkArr.push(totalOfMark.crossparallelareacount); //管道平行/交叉
        //   totalOfMarkArr.push(totalOfMark.subwayparallel); //地铁平行/交叉
        //   totalOfMarkArr.push(totalOfMark.highvoltagecorridor); //高压走廊
