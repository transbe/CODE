...
function loadTable() {
    $('#markerTable').bootstrapTable({
        ...
        onLoadSuccess: function (rows) {
            ...
            if ($.fn.bootstrapTable.defaults.pagination == true) {
                $(".fixed-table-pagination .pagination li a").off("click").on('click', function (e) {
                    if(!isSavedBatchModify()){
                        e.stopPropagation();
                        e.preventDefault();
                    }
                });
                $(".fixed-table-pagination .btn-group.dropup").off("click").on('click', function (e) {
                    if(!isSavedBatchModify()){
                        e.stopPropagation();
                    }
                });
