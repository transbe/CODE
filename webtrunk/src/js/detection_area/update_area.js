    ...
    $.ajax({
        ...
        success: function(result) {
            if (result.success == 1) {
                ...
                layer.alert(getLanguageValue("Error_loading_data"), {
    ...
    $('#showAll').bootstrapTable({
        ...
        onPageChange: function(number, size) {
            if (changeDataArr.length > 0) {
                layer.confirm(getLanguageValue("save_the_changes"), {
                    title: getLanguageValue("tip"),
                    skin: 'self'
                }, function(index) {
                    saveChangeData();
...
function updateArea(modifyFlag) {
    ...
    if (!validateResult) {
        layer.alert(getLanguageValue("tip.empty.name"), {
            title: getLanguageValue("tip"),
            skin: "self-alert"
        });
        return false;
    ...
    $.ajax({
        ...
        success: function(successResult) {
            if (successResult.success == 1) {
                parent.layer.msg(getLanguageValue("submit_successfully"), {
                ...
                parent.layer.alert(getLanguageValue("fail_to_submit"), {
                    title: getLanguageValue("tip"),
                    skin: "self-alert"
                });
                result = false;
...
function addUpdateArea(modifyFlag) {
    var validateResult = validate();
    if (!validateResult) {
        parent.layer.alert(getLanguageValue("tip.empty.name"), {
            title: getLanguageValue("tip"),
            skin: "self-alert"
        });
        return false;
    ...
    $.ajax({
        ...
        success: function(successResult) {
            if (successResult.success == 1) {
                ...
                parent.layer.alert(getLanguageValue("fail_to_save"), {
                    title: getLanguageValue("tip"),
                    skin: "self-alert"
                });
                result = false;
...
function saveChangeData() {
    ...
    $.ajax({
        ...
        success: function(successResult) {
            if (successResult.success == 1) {
                layer.msg(getLanguageValue("save_successfully"), {
                    time: MSG_DISPLAY_TIME,
                    skin: "self-msg"
                });
                changeDataArr = [];
                ...
                layer.alert(getLanguageValue("fail_to_save"), {
                    title: getLanguageValue("tip"),
                    skin: "self-alert"
                });
                changeDataArr = [];
